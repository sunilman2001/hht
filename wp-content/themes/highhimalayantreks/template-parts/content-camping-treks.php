          				...
          				<div class="row">
								...
								<div class="section-content portfolio-section"> 
                         				<div class="portfolio-box">
                                            ...
                                            <?php $current_pageid = get_the_ID(); //echo $current_pageid; ?>
												...
												<?php $camping_trekking = new WP_Query(array(
														'post_type' =>'page',			
														'post_status' => 'publish',
														'meta_query'	=> array(
															'relation'		=> 'AND',
                                                ...
                                                <?php if($camping_trekking -> have_posts()){?>   
                                                <?php while($camping_trekking->have_posts()): $camping_trekking->the_post();?>                                             
          					...
          					<div class="col-md-3 sidebarStyle">
          						<div class="sidebar triggerAnimation animated" data-animate="slideInUp">
                                        ...
                                        <?php if($exclude_sidebar != "page-camping-treks.php"){?>
                                        <div class="category-widget widget">
                                                  <h3><?php                                     
															$current = $post->ID;                                     
