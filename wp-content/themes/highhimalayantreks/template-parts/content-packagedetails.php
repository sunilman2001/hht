                                   ...
                                   <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                             <div class="modal-header">
                                                  ...
                                                  <h4 class="modal-title" id="myModalLabel">Booking Forms</h4>
                                             </div>
                                             <div class="modal-body">
                                                  <?php echo do_shortcode('[contact-form-7 id="2479" title="Booking Form"]'); ?>
                                             </div>
                         ...
                         <div class="col-md-3 sidebarStyle">
                              <div class="sidebar triggerAnimation animated" data-animate="slideInUp">
                                   ...
                                   <div class="category-widget widget">
                                        ...
                                        <?php if(get_field('fixed_departure_checked')):?>
                                        <div class="fixedDeparture">
                                             <a href="#" data-target="#fDModal" data-toggle="modal">Fixed Departure</a>
                                        </div>
                                        <!-- <//?php else : ?>
                                         <div class="fixedDeparture" style="display:none;">
                                             <a href="#" > No Fixed Departure</a>
                                        </div> -->
                                        <?php endif; ?>
                                   </div>
                                   <div class="category-widget widget">
                                   ...
                                   <div class="category-widget widget">
                                        ...
                                        <ul class="category-list">
                                             ...
                                             <?php $sub_pages = new WP_Query(array(
                                                  ...
                                                  'numberposts' => -1,
                                                  'post_status' => 'publish',
                                                  'post__not_in' => array(1411, 1413, 1442, 1415, 1417, 1420, 1422, 1424, 1361, 1363),
                                                  'order' => 'ASC'
                                             )); ?>
                                             <?php if ($sub_pages->have_posts()) { ?>
                                                  <?php while ($sub_pages->have_posts()) : $sub_pages->the_post(); ?>
